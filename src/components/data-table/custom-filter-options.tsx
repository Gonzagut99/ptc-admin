...
import { DataTableFacetedFilter as OriginalFilter } from "@/components/data-table/data-table-faceted-filter";
...
export function CustomDataTableFilter<TData, TValue>(
  props: CustomFilterProps<TData, TValue>,
) {
